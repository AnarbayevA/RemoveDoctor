    ...
    <div className="home-container">
        ...
        <header data-thq="thq-navbar" className="home-navbar">
          <div className="home-left">
            ...
            <nav className="home-links">
              ...
              <span className="home-link02">Narxlar</span>
          ...
          <div data-thq="thq-navbar-btn-group" className="home-right">
            <button className="home-phone button">
              ...
              />
              <span className="home-text06">+998-94-606-40-64</span>
            </button>
            <a href="#book" className="home-book button button-main">
              ...
              />
              <span className="home-text07">Qabulga yozilish</span>
            </a>
          </div>
          ...
          <div className="home-content">
            <div className="home-heading07">
              <h1 className="home-header07">
                Siz uchun qayg&apos;uradigan tajribali shifokorlar   
              </h1>
              <p className="home-caption6">
                Sizning sog&apos;ligingiz eng katta boyligingiz
              </p>
            </div>
      ...
      <section id="how-it-works" className="home-why">
        <div className="home-heading09">
          <h2 className="home-header08">Nima uchun bizni tanlaysiz</h2>
          <p className="home-header09">
            Bizda barcha xizmatlar kafolatlangan ,yuqori salohiyatli va 10
            yildan ortiq tajribaga ega bo&apos;lgan shifokorlarimiz sizning
            sog&apos;lig&apos;ingiz haqida qayg&apos;urishadi 
          </p>
        </div>
      ...
      <section className="home-meet">
        <div className="home-heading18">
          <h2 className="home-text81">Shifokorlarimiz bilan tanishing</h2>
